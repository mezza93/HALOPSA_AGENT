                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-amber-800">
                      Important: Full Access Required
                    </p>
                    <p className="text-sm text-amber-700 mt-1">
                      This app requires API access to read and write data in your HaloPSA instance, including tickets, clients, agents, assets, and reports. Only connect if you understand the implications.
                    </p>
                  </div>
                </div>
              </div>
